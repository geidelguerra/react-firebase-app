      ...
      <div className="rounded-lg shadow-lg border border-gray-200 p-6 w-full max-w-sm">
        ...
        <form onSubmit={handleSubmit} className="flex flex-col space-y-4">
          ...
          <div className="flex justify-end">
            <button disabled={busy} type="submit" className="border border-blue-500 bg-blue-500 px-4 py-3 rounded font-bold text-xs text-white uppercase hover:border-blue-600 transition-all duration-200">Sign in</button>
          </div>
        </form>
        <div className="flex justify-between mt-8">
          <Link to="/forgot-password" className="text-blue-500 text-sm font-bold">Forgot password?</Link>
